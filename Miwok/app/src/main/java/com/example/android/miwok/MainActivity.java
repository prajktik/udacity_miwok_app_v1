...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvFamily = (TextView) findViewById(R.id.tv_family);
        ...
        TextView tvColors = (TextView) findViewById(R.id.tv_colors);
        ...
        TextView tvPhrases = (TextView) findViewById(R.id.tv_phrases);
